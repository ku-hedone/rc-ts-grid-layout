...
export const Playground: Story<{
	...
	return (
		<div>
			...
			>
				{layout.map((item) => (
					<div key={item.i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
						{item.i.toUpperCase()}
					</div>
				))}
			</GridLayout>

			<pre style={{ marginTop: 16, padding: 12, background: '#f1f5f9', borderRadius: 8, fontSize: 12 }}>
