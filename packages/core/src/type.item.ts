...
export type InnerDragHandler = (
	e: DraggableEvent,
	data: Pick<DraggableData, 'node' | 'deltaX' | 'deltaY'>,
) => void | false;

export type InnerDragStartHandler = (
	e: DraggableEvent,
	data: Pick<DraggableData, 'node'>,
) => void | false;

export type InnerDragStopHandler = (
	e: DraggableEvent,
	data: Pick<DraggableData, 'node'>,
) => void | false;
